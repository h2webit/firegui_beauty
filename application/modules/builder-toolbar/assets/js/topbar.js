        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.only_super_admin == true) {
                    $('#js_button_user_permissions').attr('title', 'This page is visible only for SuperAdmin');
                    $('#js_check_users_permissions span').removeClass('fa-eye');
                    $('#js_check_users_permissions span').addClass('fa-eye-slash');
                    $('#js_check_users_permissions span').css('color', '#000000');
                } else {
                    $('#js_button_user_permissions').attr('title', 'This page is visible to other users');
                    $('#js_check_users_permissions span').removeClass('fa-eye-slash');
                    $('#js_check_users_permissions span').addClass('fa-eye blink_me');
                    $('#js_check_users_permissions span').css('color', '#ff0000');
