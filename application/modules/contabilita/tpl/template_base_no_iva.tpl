                        ...
                        <table class="table table-cleared">
                            ...
                            <?php foreach ($gruppo as $articolo) : if (!empty($articolo['documenti_contabilita_articoli_name'])) : ?>
                                    ...
                                    <tr class="t_rows">
                                        ...
                                        <td  colspan="2" class="left strong"><?php echo $articolo['documenti_contabilita_articoli_name']; ?>
                                            <br>
                                        ...
                                        <td class="right"><?php echo $valuta[$documento['documenti_contabilita_valuta']]; ?>
                                            <?php 
                                            if ($articolo['documenti_contabilita_articoli_imponibile'] > 0) {
                                                echo $segno . number_format((float)$articolo['documenti_contabilita_articoli_imponibile'], 2, '.', '');
                                            } else {
                                                $imponibile = (float)$articolo['documenti_contabilita_articoli_prezzo'] * (float)$articolo['documenti_contabilita_articoli_quantita'];
                                                echo $segno . number_format((float)$imponibile, 2, '.', '');
                                            }
                                            ?>
                                        </td>
                                    </tr>
