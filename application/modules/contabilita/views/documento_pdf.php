                ...
                <div class="row small-margin">
                    <div class="col-md-3">
                        <?php if (!empty($settings['documenti_contabilita_settings_company_logo'])) : ?>
                            <img src="<?php echo $settings['documenti_contabilita_settings_company_logo']; ?>" alt="" class="m_logo img-responsive" />
                        <?php else : ?>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-sm-4 mittente1">
                            ...
                            <div class="" style="float: left;">
                                <div>
                                    <strong style="color: #4b8ffc;"><?php echo $settings['documenti_contabilita_settings_company_name']; ?></strong>
                                </div>
                                <div>P.IVA <?php echo $settings['documenti_contabilita_settings_company_vat_number']; ?></div>
                                <div>CF <?php echo $settings['documenti_contabilita_settings_company_codice_fiscale']; ?></div>
                                <div>Codice SDI <?php echo $settings['documenti_contabilita_settings_codice_sdi']; ?></div>
                        ...
                        <div class="col-sm-4 destinatario">
                            ...
                            <div>P.IVA <?php echo $destinatario['partita_iva']; ?></div>
                            <div>CF <?php echo $destinatario['codice_fiscale']; ?></div>
                        ...
                        <div class="col-sm-4">
                            <div class="document">
                                ...
                                <strong>Documento: </strong><br><strong style="color: #4b8ffc">nr. <?php echo $documento['documenti_contabilita_numero']; ?> <?php echo ($documento['documenti_contabilita_numero']) ? '/' . $documento['documenti_contabilita_serie'] : ''; ?>
                    ...
                    <div class="table-responsive-sm table_articoli">
                        ...
                        <table class="table table-cleared">
                            ...
                            <?php foreach ($gruppo as $articolo) : if (!empty($articolo['documenti_contabilita_articoli_name'])) : ?>
                                    ...
                                    <?php if ($articolo['documenti_contabilita_articoli_iva_perc'] != $iva_perc_before or !$iva_perc_before) : ?>
                                        ...
                                        <tr class="table_title">
                                            ...
                                            <th class="right">
                                                IVA <?php echo number_format((float)$articolo['documenti_contabilita_articoli_iva_perc'], 2, '.', ''); ?>%
                                            </th>
                                    ...
                                    <tr class="t_rows">
                                        ...
                                        <td class="right"><?php echo $valuta[$documento['documenti_contabilita_valuta']]; ?><?php echo number_format((float)$articolo['documenti_contabilita_articoli_prezzo'], 2, '.', ''); ?><?php echo ($articolo['documenti_contabilita_articoli_sconto']) ? "<br /><small>Sconto " . number_format((float)$articolo['documenti_contabilita_articoli_sconto'], 2, '.', '') . '% </small>' : ''; ?></td>

                                        <td class="center"><?php echo $articolo['documenti_contabilita_articoli_quantita']; ?></td>
                                        <td class="right"><?php echo $valuta[$documento['documenti_contabilita_valuta']]; ?><?php echo $segno . number_format((float)$articolo['documenti_contabilita_articoli_iva'], 2, '.', ''); ?></td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="right">Competenze</td>
                            ...
                            <?php if ($documento['documenti_contabilita_importo_bollo'] > 0) : ?>
                                <tr>
                                    ...
                                    <td colspan="2" class="right">Bollo su quietanza</td>
                            ...
                            <?php if ($documento['documenti_contabilita_cassa_professionisti_valore'] > 0) : ?>
                                <tr>
                                    ...
                                    <td colspan="3" class="right">Cassa
                                        professionisti <?php echo number_format((float)$documento['documenti_contabilita_cassa_professionisti_perc'], 2, '.', ''); ?></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td colspan="3" class="right">Imponibile</td>
                            ...
                            <?php if ($documento['documenti_contabilita_ritenuta_acconto_valore'] > 0) : ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td colspan="3" class="right">Ritenuta d'acconto
                            ...
                            if (!empty($documento['documenti_contabilita_imponibile_iva_json'])) :
                                foreach (json_decode($documento['documenti_contabilita_imponibile_iva_json']) as $id_iva => $foo) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td class="right" colspan="2">IVA <?php echo $percentuale; ?>%</td>
                            ...
                            <?php if ($pagina == count($gruppi_articoli)) : ?>
                                ...
                                <tr class="blu">
                                    ...
                                    <td class="right" colspan="3" style="padding: 10px;">
                            ...
                            <?php if (!empty($iva) || $documento['documenti_contabilita_split_payment'] == DB_BOOL_TRUE) : ?>
                                ...
                                <?php foreach ($iva as $i) : ?>
                                    ...
                                    ?>
                                    <tr class="">
                                        <td colspan="6"><?php echo number_format((float)$i['valore'], 2, '.', ''); ?>% - <?php echo $i['descrizione']; ?></td>
                                    </tr>
                                <?php endforeach; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 paginator">
                            Pagina <?php echo $pagina; ?>/<?php echo count($gruppi_articoli); ?>
                        </div>
