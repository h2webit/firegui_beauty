                        ...
                        <div class="row row_scadenza">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="scadenze[<?php echo $key; ?>][documenti_contabilita_scadenze_saldato_con]" class="js_scadenze_select2 js_table_select2 js_table_select2<?php echo $key; ?>" data-name="documenti_contabilita_scadenze_saldato_con" style="display:block;width:100%">
                                    ...
                                    <script>
                                        $('.js_table_select2<?php echo $key; ?>').val('<?php echo $scadenza['documenti_contabilita_scadenze_saldato_con']; ?>').trigger('change.select2');
                                    </script>
                                </div>
                            </div>
                            <div class="col-md-3">
