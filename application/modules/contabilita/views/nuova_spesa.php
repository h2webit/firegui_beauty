...
<form class="formAjax" id="new_spesa" action="<?php echo base_url('contabilita/spese/create_spesa'); ?>">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="row bg-light-blue" style="background-color:#e0eaf0;">
                <div class="col-md-12">
...
<?php endforeach; */?>
                    ...
                    <div class="col-md-2">
                        <label style="min-width:80px">Tipologia fattura reverse:</label>
                        <select name="spese_tipologia_autofattura" class="select2 form-control">
                            ...
                            <?php foreach ($tipologie_fatturazione as $tipologia): ?>
                                <?php if (in_array($tipologia['documenti_contabilita_tipologie_fatturazione_codice'], ['TD17', 'TD18', 'TD19'])): ?>
                                    <option value="<?php echo $tipologia['documenti_contabilita_tipologie_fatturazione_id']; ?>" <?php if (($tipologia['documenti_contabilita_tipologie_fatturazione_codice'] == 'TD17' && empty($spesa_id)) || (!empty($spesa['spese_tipologia_autofattura']) && $spesa['spese_tipologia_autofattura'] == $tipologia['documenti_contabilita_tipologie_fatturazione_id'])): ?> selected="selected" <?php endif;?>><?php echo "{$tipologia['documenti_contabilita_tipologie_fatturazione_codice']} {$tipologia['documenti_contabilita_tipologie_fatturazione_descrizione']}"; ?></option>
                                <?php endif;?>
                            <?php endforeach;?>
...
if (!empty($spesa[$key])): ?><?php echo $spesa[$key]; ?><?php endif;?>">
    ...
    ?>
							                                <div class="row row_scadenza">
							                                    ...
							                                    <div class="col-md-3">
							                                        <div class="form-group">
							                                            <label>Metodo di pagamento</label> <select name="scadenze[<?php echo $key; ?>][spese_scadenze_saldato_con]" class="_select2 form-control _js_table_select2 _js_table_select2<?php echo $key; ?> js_spese_scadenze_saldato_con" data-name="spese_scadenze_saldato_con">
                                            ...
                                            <script>
                                                $('.js_table_select2<?php echo $key; ?>').val('<?php echo $scadenza['spese_scadenze_saldato_con']; ?>').trigger('change.select2');
                                            </script>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                        ...
                        <div class="row row_scadenza">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Ammontare</label> <input type="text" name="scadenze[1][spese_scadenze_ammontare]" class="form-control spese_scadenze_ammontare" placeholder="Ammontare" value="<?php echo $ammontare; ?>" data-name="spese_scadenze_ammontare" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Scadenza</label>
                                    <div class="input-group js_form_datepicker date ">
                                        <input type="text" name="scadenze[1][spese_scadenze_scadenza]" class="form-control js_spese_scadenze_scadenza js_form_datepicker" placeholder="Scadenza" value="<?php echo ($data_scadenza) ? $data_scadenza : date('d/m/Y'); ?>" data-name="spese_scadenze_scadenza" />
                                        <span class="input-group-btn">
                                            <button class="btn btn-default" type="button" style="display:none"><i class="fas fa-calendar-alt-alt"></i></button>
                                        </span>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="scadenze[1][spese_scadenze_saldato_con]" class="select2 form-control js_table_select2 js_table_select2<?php echo $key; ?>" data-name="spese_scadenze_saldato_con">
    ...
    ?> selected="selected" <?php endif;?>>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Data saldo</label>
                                    <div class="input-group js_form_datepicker date  field_68">
                                        <input type="text" class="form-control" name="scadenze[1][spese_scadenze_data_saldo]" id="empty_date" data-name="spese_scadenze_data_saldo" value="<?php echo $data_saldo; ?>">
